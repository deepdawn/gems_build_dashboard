...
export const CardC_TaskPerAsset: React.FC<CardCProps> = ({ data = [], currentValue = 0, centerAvg = 0, companyAvg = 0, periodLabel = '' }) => {
        ...
        {data.length > 0 ? (
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={data} margin={{ top: 15, right: 30, left: -20, bottom: 0 }}>
              ...
              <Tooltip formatter={(value: any) => [`${Number(value).toFixed(2)}건`, '대당 작업량']} />
